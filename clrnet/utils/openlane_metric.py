...
def openlane_metric(
    pred, anno, width=30, iou_thresholds=[0.5], official=True, img_shape=(590, 1640, 3)
):
    _metric = {}
...
def load_openlane_data(data_dir, file_list_path):
...
def eval_predictions(
    ...
    predictions = load_openlane_data(pred_dir, list_path)
    annotations = load_openlane_data(anno_dir, list_path)
